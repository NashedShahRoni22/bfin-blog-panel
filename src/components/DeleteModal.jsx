export default function DeleteModal({ closeModal, category }) {
  return (
    <div className="inline-block w-full rounded-lg bg-white pb-6 pt-4 shadow-2xl md:w-[27.5rem]">
      ...
      <div className="px-4">
        ...
        <div className="flex items-center gap-4">
          <button className="mx-auto w-full rounded-lg border border-red-100 bg-red-50 px-4 py-2 text-lg font-medium capitalize text-red-400 transition-all duration-200 ease-linear hover:border-red-400 hover:bg-red-100 hover:text-red-500 lg:mx-0">
            Delete
          </button>
          <button
            onClick={closeModal}
